...
- Location: tests/tour.spec.js:9:3
...
Call log:
  - waiting for locator('text=Comenzar la historia')
    - locator resolved to <button tabindex="0" class="inline-flex items-center justify-center rounded-2xl font-bold transition-all focus:outline-none focus:ring-2 focus:ring-cyan-500 disabled:opacity-50 disabled:cursor-not-allowed bg-gradient-to-r from-cyan-600 to-indigo-700 text-white shadow-[0_8px_20px_-5px_rgba(6,182,212,0.4)] group px-12 py-6 text-lg uppercase tracking-widest gap-4">…</button>
