...
export default function SearchExplorer() {
  ...
  const { data: brandsData } = useSWR(
    `${baseUrl}/api/insights/brands`,
    fetcher,
  );
  const { data: provincesData } = useSWR(
    `${baseUrl}/api/insights/provinces`,
    fetcher,
  );
  const { data: fuelsData } = useSWR(
    `${baseUrl}/api/insights/distribution/fuel`,
    fetcher,
  );
  const { data: transmissionsData } = useSWR(
    `${baseUrl}/api/insights/distribution/transmission`,
    fetcher,
  );
  ...
  const queryUrl = useMemo(() => {
    ...
    if (filters.transmissions)
      params.append("transmissions", filters.transmissions);
  ...
  const isCarInComparison = (carId) =>
    comparisonList.some((c) => c.car_id === carId);
          ...
          <div className="flex items-center gap-4 w-full md:w-auto">
            ...
            <div>
              <h2 className="text-xl font-black italic tracking-tighter leading-none">
                Crautos <span className="text-blue-400">Search</span>
              </h2>
        ...
        <aside className="hidden lg:block w-72 shrink-0 space-y-8">
            ...
            <div className="space-y-6">
              <div className="space-y-3">
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    onChange={(e) =>
                      setFilters((p) => ({ ...p, price_min: e.target.value }))
                    }
                    className="w-full bg-white/5 border border-white/10 rounded-xl p-2 text-xs focus:ring-1 focus:ring-blue-500/50 outline-none"
                  />
                  <input
                    type="number"
                    placeholder="Max"
                    ...
                    onChange={(e) =>
                      setFilters((p) => ({ ...p, price_max: e.target.value }))
                    }
                    className="w-full bg-white/5 border border-white/10 rounded-xl p-2 text-xs focus:ring-1 focus:ring-blue-500/50 outline-none"
                  />
                </div>
              ...
              <div className="space-y-3">
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    onChange={(e) =>
                      setFilters((p) => ({ ...p, year_min: e.target.value }))
                    }
                    className="w-full bg-white/5 border border-white/10 rounded-xl p-2 text-xs focus:ring-1 focus:ring-blue-500/50 outline-none"
                  />
                  <input
                    ...
                    onChange={(e) =>
                      setFilters((p) => ({ ...p, year_max: e.target.value }))
                    }
                    className="w-full bg-white/5 border border-white/10 rounded-xl p-2 text-xs focus:ring-1 focus:ring-blue-500/50 outline-none"
                  />
                </div>
              ...
              <div className="space-y-3">
                ...
                <select
                  ...
                  onChange={(e) =>
                    setFilters((p) => ({ ...p, provinces: e.target.value }))
                  }
                  ...
                  {fuels.map((f) => (
                    <button
                      ...
                      onClick={() =>
                        setFilters((p) => ({
                          ...p,
                          fuels: p.fuels === f.combustible ? "" : f.combustible,
                        }))
                      }
                      className={cn(
              ...
              <div className="space-y-3">
                ...
                <select
                  ...
                  className="w-full bg-white/5 border border-white/10 rounded-xl p-3 text-xs focus:ring-1 focus:ring-blue-500/50 outline-none appearance-none cursor-pointer"
                >
                  <option value="año:desc" className="bg-zinc-900">
                    Más Recientes
                  </option>
                  <option value="precio_usd:asc" className="bg-zinc-900">
                    Menor Precio
                  </option>
                  <option value="precio_usd:desc" className="bg-zinc-900">
                    Mayor Precio
                  </option>
                  <option
                    value="kilometraje_number:asc"
                    className="bg-zinc-900"
                  >
                    Menor Kilometraje
                  </option>
          ...
          <div className="p-6 bg-blue-600/10 border border-blue-500/20 rounded-3xl space-y-4">
            ...
            <p className="text-xs text-white/60 leading-relaxed italic">
              "Recuerda que los autos con menos de 80,000km suelen tener mejor
              valor de reventa en Costa Rica."
            </p>
          </div>
        </aside>
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
            <div>
              ...
              <p className="font-mono text-xs text-white/30 uppercase mt-4 tracking-tighter">
                ...
                de {total.toLocaleString()} anuncios activos
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 gap-6 min-h-[50vh]">
              ...
              <motion.div
                ...
                className={cn(
                  ...
                  isCarInComparison(car.car_id) &&
                    "ring-2 ring-blue-500 border-transparent shadow-[0_0_30px_rgba(59,130,246,0.3)]",
                )}
              >
                ...
                <div className="aspect-[16/10] bg-white/5 relative overflow-hidden flex items-center justify-center">
                  ...
                  <Car
                    ...
                    size={80}
                    style={{ display: car.imagen_principal ? "none" : "block" }}
                  />
                  <div className="absolute top-4 right-4 px-3 py-1 rounded-full glass border border-white/10 text-xs font-black italic text-blue-400 z-10">
                    {car.año}
                  </div>
                </div>
                ...
                <div className="p-6 flex-1 flex flex-col gap-5">
                  <div>
                    ...
                    <p className="text-2xl font-black tracking-tighter leading-none truncate">
                      {car.modelo}
                    </p>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-4 py-4 border-y border-white/5">
                    <div className="flex items-center gap-2 text-white/50">
                      ...
                      <span className="text-[11px] font-black uppercase truncate">
                        {car.informacion_general?.kilometraje_number?.toLocaleString() ||
                          "0"}{" "}
                        KM
                      </span>
                    </div>
                    <div className="flex items-center gap-2 text-white/50">
                      ...
                      <span className="text-[11px] font-black uppercase truncate">
                        {car.informacion_general?.provincia || "N/A"}
                      </span>
                    </div>
                  </div>
            ...
            {initialLoading &&
              ...
              Array.from({ length: 6 }).map((_, i) => (
                <div
                  key={i}
                  className="glass rounded-3xl h-[400px] animate-pulse opacity-10"
                />
              ))}
          </div>
          ...
          {!initialLoading && allCars.length === 0 && (
            <div className="text-center py-20 glass rounded-3xl border border-white/5">
              ...
              <p className="text-white/40 mt-2">
                Prueba ajustando los filtros o cambiando la búsqueda.
              </p>
              <button
                onClick={() => {
                  setSearchQuery("");
            ...
            <div className="max-w-7xl mx-auto flex items-center justify-between gap-6">
              <div className="flex items-center gap-4 overflow-x-auto pb-2 scrollbar-none">
                <div className="flex -space-x-3">
                  {comparisonList.map((car, i) => (
                    <div
                      key={car.car_id}
                      className="w-12 h-12 rounded-2xl bg-blue-600 border-2 border-zinc-900 flex items-center justify-center shadow-xl overflow-hidden relative"
                    >
                      {car.imagen_principal ? (
                        <img
                          src={car.imagen_principal}
                      ...
                      <Car
                        ...
                        style={{
                          display: car.imagen_principal ? "none" : "block",
                        }}
                      />
                    </div>
                  ))}
                  {Array.from({ length: 3 - comparisonList.length }).map(
                    (_, i) => (
                      <div
                        key={i}
                        className="w-12 h-12 rounded-2xl bg-white/5 border-2 border-zinc-900 border-dashed flex items-center justify-center"
                      />
                    ),
                  )}
                </div>
                <div className="hidden sm:block">
                  <p className="text-sm font-black italic tracking-tighter">
                    {comparisonList.length} / 3 vehículos seleccionados
                  </p>
              ...
              <div className="flex items-center gap-3">
                <button
                  ...
                  className="p-4 rounded-2xl bg-white/5 hover:bg-white/10 text-white/40 transition-colors"
                >
                  <X size={20} />
                </button>
                <button
          ...
          >
            <div className="max-w-6xl mx-auto w-full space-y-12">
              <div className="flex justify-between items-center">
                <div>
                  <h2 className="text-4xl font-black italic tracking-tighter text-blue-400">
                    Batalla de Titanes
                  </h2>
                  <p className="text-white/40 uppercase font-black text-xs tracking-widest mt-2">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {comparisonList.map((car) => (
                  <div
                    key={car.car_id}
                    className="glass rounded-3xl overflow-hidden border border-white/10 p-8 space-y-8 h-full bg-white/5 flex flex-col"
                  >
                    <div className="w-full aspect-[16/10] bg-black/20 rounded-2xl overflow-hidden relative flex items-center justify-center shrink-0 mb-4">
                      {car.imagen_principal ? (
                        <img
                          src={car.imagen_principal}
                          alt={`${car.marca} ${car.modelo}`}
                    ...
                    <div className="text-center space-y-2">
                      ...
                      <p className="text-3xl font-mono font-black text-green-400 mt-4">
                        ${car.precio_usd?.toLocaleString()}
                      </p>
                    </div>
                    ...
                    <div className="space-y-6 pt-6 border-t border-white/10">
                      ...
                      <div className="space-y-1">
                        ...
                        <p className="font-bold text-lg">
                          {car.informacion_general?.combustible || "N/A"}
                        </p>
                      </div>
                      <div className="space-y-1">
                        <p className="text-[10px] text-white/30 uppercase font-black tracking-widest">
                        ...
                        <p className="font-bold text-lg">
                          {car.informacion_general?.transmisión || "N/A"}
                        </p>
                      </div>
                      <div className="space-y-1">
                        <p className="text-[10px] text-white/30 uppercase font-black tracking-widest">
            ...
            >
              ...
              <div className="flex flex-col gap-8">
                <div className="flex gap-6 items-start">
                  <div className="w-24 h-24 bg-blue-600/20 rounded-3xl flex items-center justify-center shrink-0 border border-blue-500/30 overflow-hidden relative">
                    {selectedCar.imagen_principal ? (
                      <img
                        src={selectedCar.imagen_principal}
                    ...
                    <Car
                      ...
                      style={{
                        display: selectedCar.imagen_principal
                          ? "none"
                          : "block",
                      }}
                    />
                  ...
                  <div className="flex-1">
                    <p className="text-blue-400 font-extrabold uppercase tracking-widest text-[10px] mb-1">
                      {selectedCar.marca}
                    </p>
                    <h2 className="text-4xl font-black italic tracking-tighter italic leading-[0.9]">
                      {selectedCar.modelo}
                    </h2>
                    <div className="flex gap-3 mt-4">
                      <span className="px-3 py-1 bg-white/5 rounded-full text-[10px] font-black uppercase text-white/50">
                        {selectedCar.año}
                      </span>
                      <span className="px-3 py-1 bg-green-500/10 rounded-full text-[10px] font-black uppercase text-green-400 italic">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                  {[
                    {
                      label: "Precio USD",
                      val: `$${selectedCar.precio_usd?.toLocaleString()}`,
                      icon: DollarSign,
                    },
                    {
                      label: "Kilometraje",
                      val: `${selectedCar.informacion_general?.kilometraje_number?.toLocaleString()} KM`,
                      icon: Gauge,
                    },
                    {
                      label: "Combustible",
                      val:
                        selectedCar.informacion_general?.combustible || "N/A",
                      icon: Droplets,
                    },
                    {
                      label: "Transmisión",
                      val:
                        selectedCar.informacion_general?.transmisión || "N/A",
                      icon: Zap,
                    },
                    {
                      label: "Provincia",
                      val: selectedCar.informacion_general?.provincia || "N/A",
                      icon: MapPin,
                    },
