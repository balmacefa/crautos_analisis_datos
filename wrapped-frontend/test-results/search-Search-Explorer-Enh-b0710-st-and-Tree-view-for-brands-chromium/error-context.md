...
- Name: search.spec.js >> Search Explorer Enhancements >> should toggle between List and Tree view for brands
- Location: tests\search.spec.js:27:3
...
Call log:
  - waiting for locator('aside button').nth(1)
    - locator resolved to <button class="p-1.5 rounded-md transition-all text-white/40 hover:text-white">…</button>
